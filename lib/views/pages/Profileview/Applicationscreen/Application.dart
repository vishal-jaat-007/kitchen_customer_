...
// ------Change theme----
import 'package:tiffin_service_customer/views/pages/Profileview/Applicationscreen/widget/Switchadaptive.dart';
import 'package:tiffin_service_customer/views/pages/Profileview/widget/profiletile.dart';


// ------------ PART---
part 'Applicationsetting.dart';
part 'Changenotification.dart';
part 'changelanguage.dart';
part 'changetheme.dart';
